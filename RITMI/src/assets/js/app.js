    ...
    function(e, t, n) {
         ...
         */ !(function(t, n) {
            ...
            C.extend({
                ...
                (C.cssHooks.marginLeft = Xe(v.reliableMarginLeft, function(
                    e,
                    t
                ) {
                    if (t)
                    ...
                    if (
                        ...
                        for (o = 0; (a = h[o++]) && !e.isPropagationStopped(); )
                            (d = a),
                                ...
                                (c =
                                    (J.get(a, "events") || Object.create(null))[
                                        e.type
                            ...
                            i ||
                                ...
                                (l &&
                                    ...
                                    e.isPropagationStopped() &&
                                        d.addEventListener(g, Ct),
                                    r[g](),
                                    e.isPropagationStopped() &&
                                        d.removeEventListener(g, Ct),
                    ...
                    ajax: function(e, t) {
                        ...
                        function S(e, t, a, u) {
                            ...
                            l ||
                                ...
                                (k.statusText = (t || T) + ""),
                                f
                                    ? v.resolveWith(h, [d, T, k])
                                    : v.rejectWith(h, [k, T, x]),
                                k.statusCode(y),
                                (y = void 0),
                                c &&
            ...
            C.ajaxSetup({
                ...
                (v.createHTMLDocument =
                    (((Vt = x.implementation.createHTMLDocument("")
                    ...
                    position: function() {
                        if (this[0]) {
                            ...
                            return {
                                ...
                                left:
                                    t.left - i.left - C.css(r, "marginLeft", !0)
                            };
                        }
                    },
    ...
    function(e, t, n) {
        ...
        i()(window).on("load", function() {
            ...
            i()(document).ready(function(e) {
                i()(".header__burger").on("click", function() {
                    i()(".menu").addClass("menu-active"),
                        setTimeout(function() {
                            i()(".info").addClass("info-active");
                        }, 200),
                        i()("body").addClass("lock");
                }),
                    i()(".header__close").on("click", function() {
                        i()(".menu")
                            .removeClass("menu-active")
                            .find(".header__info")
                            .remove(),
                            i()(".info").removeClass("info-active"),
            ...
            i()(document).ready(function(e) {
                i()(".akr-title-js").on("click", function() {
                    var e = i()(this).siblings(".akr-drop-js"),
                        t = i()(this).find(".akr-item-img-js"),
                        n = i()(this).parent(".akr__item");
                    i()(this).hasClass("act")
                        ? (i()(this).removeClass("act"),
            ...
            i()(document).ready(function() {
                i()(".select").each(function() {
                    ...
                    var r = e.next(".new-select");
                    i()("<div>", { class: "new-select__list" }).insertAfter(r);
                    for (var o = r.next(".new-select__list"), a = 0; a < n; a++)
                        i()("<div>", {
                            class: "new-select__item",
                            html: i()("<span>", { text: t.eq(a).text() })
                        })
                            .attr("data-value", t.eq(a).val())
                            .appendTo(o);
                    i()(".new-select__item:first-child").fadeOut(1);
                    var s = o.find(".new-select__item");
                    o.slideUp(0),
                        r.on("click", function() {
                            i()(this).hasClass("on")
                                ? (i()(this).removeClass("on"), o.slideUp(200))
                                : (i()(this).addClass("on"), o.slideDown(200));
                        }),
                        s.on("click", function() {
                            i()(".new-select__item").removeClass("choosen");
                            var e = i()(this)
                                .addClass("choosen")
                                .data("value");
                            i()("select")
            ...
            i()(document).ready(function() {
                i()(".select").on("click", function() {
                    i()(this)
                        .siblings(".block__icon")
            ...
            i()(document).mouseup(function(e) {
                ...
                t.is(e.target) ||
                    ...
                    (i()(".new-select").removeClass("on"),
                    i()(".new-select__list").slideUp(300));
            });
        n(2), n(4);
    }
]);
